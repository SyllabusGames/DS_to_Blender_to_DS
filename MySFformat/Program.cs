...
namespace MySFformat
{
	...
	enum FileTypes {gltf2 , collada , obj , stl , /*3ds , */fbx}
	...
	*/
		//    string fname = openFileDialog1.FileName;
			orgFileName = "C:/Users/nsrul/Desktop/DS To Blender/bridge.flver";
			fname = orgFileName;
			FLVER b = null;
			if (fname.Length > 4) 
			{
				if (fname.Substring(fname.Length-4) == ".dcx") 
				{
					...
					try
					{
						...
						bnds = SoulsFormats.SoulsFile<SoulsFormats.BND4>.Read(fname);
					}
			...
			Button buttonToBlend = new Button();
			ButtonTips("Export to Blend", buttonToBlend);
